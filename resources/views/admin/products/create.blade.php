     ...
     <form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class='col-md-12 mb-3'>
                ...
                <input type='text' name='discounted_price' value="{{ old('discounted_price') }}" class="form-control" placeholder="Enter Discounted Price">
            </div>
        </div>    
        ...
        <div class="row">
          ...
          <div class="row mt-2">
            ...
            <div class='col-md-6 mb-3'>
                ...
                <input type='text' name='stock_quantity' value="{{ old('stock_quantity') }}" class="form-control" placeholder="Enter Stock Quantity" required >
            </div>
            {{-- season--}}
            <div class='col-md-6 mb-3'>
        ...
        <div class="row">
            ...
            <div class='col-md-6 mb-3'>
                ...
                <select name="is_new_arrival" class="form-select" required>
                    <option value="1" {{ old('is_new_arrival') == '1' ? 'selected' : '' }}>True</option>
                    <option value="0" {{ old('is_new_arrival') == '0' ? 'selected' : '' }}>False</option>
                </select>
            </div>
            {{-- is best selling --}}
            <div class='col-md-6 mb-3'>
                ...
                <select name="is_best_selling" class="form-select" required>
                    <option value="1" {{ old('is_best_selling') == '1' ? 'selected' : '' }}>True</option>
                    <option value="0" {{ old('is_best_selling') == '0' ? 'selected' : '' }}>False</option>
                </select>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class='col-md-6 mb-3'>
                ...
                <select name="is_recommended" class="form-select" required>
                    <option value="1" {{ old('is_recommended') == '1' ? 'selected' : '' }}>True</option>
                    <option value="0" {{ old('is_recommended') == '0' ? 'selected' : '' }}>False</option>
                </select>
            </div>
            {{-- category --}}
            <div class='col-md-6 mb-3'>
