...
<body class="homepage">
  ...
  <div class="search-popup">
    <div class="search-popup-container">
      ...
      <form role="search" method="GET" class="form-group" action="{{ route('home.search') }}">
      ...
      <ul class="cat-list">
        ...
        <li class="cat-list-item">
          <a href="{{ route('home.shopByCategory', $category->slug) }}" title="{{ $category->name }}">{{ $category->name }}</a>
        </li>  
        @endforeach
    ...
    <div class="offcanvas-body">
      <div class="order-md-last">
        ...
        <ul class="list-group mb-3">
          ...
          <li class="list-group-item d-flex justify-content-between lh-sm">
            <div>
              ...
              <p class="text-body-secondary">Quantity : {{ $item['quantity'] }}</p>
            </div>
          ...
          <li class="list-group-item d-flex justify-content-between lh-sm">
            <div class='row'>
              <div class='col-md-6'>
                ...
                <small class="text-body-secondary">Brief descriptionddfsfdsfdsfdsfdsfdsfdsfdsdsfdfdsdsfdsfdsfdsfdsfdf</small>
                <p class="text-body-secondary">Quantity - 3</p>
              </div>
              <div class='col-md-6'>
                 <img src="{{ asset('images/default-product.jpg') }}" width="30" height='40'>
              <span class="text-body-secondary">Price - $8</span>
            </div>
          </div> --}}
        ...
        @if ( session()->has('cart')  && count(session('cart')) > 0 )
          <a href="{{ route('home.clearCart') }}" class="btn btn-danger btn-sm w-100 mt-2 mb-2">Clear Cart</a>
          <a class="w-100 btn btn-primary btn-lg" href="{{ route('home.cart') }}">View Cart</a>
        @endif
        @else
