  ...
  <div class="row">
    ...
    {{-- <div class="col-md-9"> --}}
      ...
      @endphp
        <div class="row">
            <div class='col-md-10'>
                <h3 class="text-center">Showing ({{ $total }}) Search Results For: ({{ $search }}) </h3>
            </div>
            <div class="col-md-2">
                <a href={{ route("home.shop") }} class="btn btn-success" style="margin-top:35px; border-radius:50px;">Reset Search</a>
            </div>
        </div>
        <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 mb-4">
            <div class="card h-100 text-center">
              ...
              <div class="card-body">
                ...
                <div class="d-flex align-items-center" style="margin-left:145px">
                  {{-- Minus Button --}}
